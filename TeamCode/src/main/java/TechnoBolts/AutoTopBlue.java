...
//        opModeTimer.resetTimer();
    ...
    private final Pose startPose = new Pose(21.68888888888888, 122.4888888888889, Math.toRadians(320));

    private final Pose shootPose = new Pose(69.15555555555557, 78.11111111111111, Math.toRadians(320));

    private final Pose shootPosePresetPose = new Pose(55.644444444444446,94.75555555555556, Math.toRadians(180));;

    private final Pose presetPose = new Pose(38.4, 95.64444444444445, Math.toRadians(180));

    private final Pose Preset1PosIntakePose = new Pose(69.15555555555557, 78.11111111111111, Math.toRadians(320));
//    private final Pose IntakePoseShootPosePreset1 = new Pose(69.15555555555557, 78.11111111111111, Math.toRadians((360 - 225)));
//    private final Pose ShootPosPreset3Pos = new Pose(43.73333333333333, 49.95555555555555, Math.toRadians(360));
//    private final Pose Preset3PosIntakePose = new Pose(31.28888888888889, 49.95555555555555, Math.toRadians(360));
//    private final Pose IntakePoseShootPosePreset3 = new Pose(69.15555555555557, 78.11111111111111, Math.toRadians(120));
