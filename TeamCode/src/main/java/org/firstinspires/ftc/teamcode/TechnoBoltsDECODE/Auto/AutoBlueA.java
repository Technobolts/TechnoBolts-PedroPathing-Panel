...
public class AutoBlueA {
    ...
    public AutoBlueA(Follower follower, Telemetry telemetry, DcMotor intake, DcMotorEx turretShooter, Servo Kicker, Servo Spindexer, Servo turretHood, Limelight3A limelight, NormalizedColorSensor colorSensor, DistanceSensor distanceSensor, DcMotorEx turret) {
...
//        opModeTimer.resetTimer();
    ...
    private final Pose startPose = new Pose(19.20000111111111, 124.25887777777776, Math.toRadians(315));
