...
public class AutoBlueC {
    ...
    public AutoBlueC(Follower follower, Telemetry telemetry, DcMotor intake, DcMotorEx turretShooter, Servo Kicker, Servo Spindexer, Servo turretHood, Limelight3A limelight, NormalizedColorSensor colorSensor, DistanceSensor distanceSensor, DcMotorEx turret) {
