...
public class ExAutoBottomBlue {
    ...
    public ExAutoBottomBlue(Follower follower, Servo flip1, DcMotor intake, DcMotor launcher1, DcMotor launcher2) {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Starttoshoot1 = follower.pathBuilder()  // this sets up all the paths with the control points and heading
