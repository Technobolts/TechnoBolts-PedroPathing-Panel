...
public class TechnoBoltsHuskyLensDistance extends LinearOpMode {
    ...
    // ====== CAMERA RESOLUTION ======
    private static final double IMAGE_WIDTH  = 20.32; //8 inches
    private static final double IMAGE_HEIGHT = 21.59; //8.5 inches
    ...
    private static final double CALIB_KNOWN_DISTANCE_CM = 203.2;
    private static final double CALIB_KNOWN_HEIGHT_PX   = 38.1;
